...
const input =
  'w-full px-3 py-2 bg-white border border-[var(--color-surface3)] rounded-[--radius] text-sm text-[var(--color-ink)] placeholder:text-[var(--color-ink-4)] focus:outline-none focus:ring-2 focus:ring-[var(--color-green)/20] focus:border-[var(--color-green)] transition-colors';
